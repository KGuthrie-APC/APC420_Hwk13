 ...
 * 
 * This class attempts to authenticate a user using Kerberos authentication
 * service. If successful, it then run an Action object where access control
 * checks for security-sensitive operations will be based on the permissions of
 * the subject that runs the code.
 */
public class Authorization {

	/*
	 * Set system properties for JAAS configuration file location, Kerberos realm,
	 * and KDC server.
	 */
	...
	public static void main(String[] args) {
		...
		// 2. attempt authentication (you must stop the program if an exception is
		// thrown)
		// TODO
		try {
			lc.login();
		...
		try {
			...
			System.err.println("Cannot create PrivilegedAction.  " + e.getMessage());
			System.exit(-1);
		}
